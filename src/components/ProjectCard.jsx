...
const THUMB_ICONS = {
  plotdr: (
    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" aria-hidden="true">
      <path d="M4 4h14M4 8h10M4 12h12M4 16h8" stroke="#888880" strokeWidth="1.5" strokeLinecap="round" />
    </svg>
  ),
  hookdr: (
    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" aria-hidden="true">
      <path d="M3 16L7 9l4 4 4-7 3 4" stroke="#888880" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  ),
  aidevice: (
    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" aria-hidden="true">
      <circle cx="11" cy="11" r="5" stroke="#888880" strokeWidth="1.5" />
      <path d="M11 3v2M11 17v2M3 11h2M17 11h2" stroke="#888880" strokeWidth="1.5" strokeLinecap="round" />
    </svg>
  ),
}
    ...
    <div className="project-card" onClick={() => navigate(`/projects/${project.id}`)}>
      <div className="project-card__thumb">
        <div className="project-card__thumb-inner">
          <div className="project-card__thumb-icon">
            {THUMB_ICONS[project.id]}
          </div>
        ...
        <span className="project-card__video-badge">Video coming soon</span>
      </div>
