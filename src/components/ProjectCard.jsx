  ...
  return (
    <div className="project-card" onClick={() => navigate(`/projects/${project.id}`)}>
      <div className="project-card__thumb">
        ...
        <span className="project-card__video-badge">{isComplete ? 'Demo video coming soon' : 'Video coming soon'}</span>
      </div>
      <div className="project-card__body">
        ...
        <button className="project-card__link">View Details <svg width="13" height="13" viewBox="0 0 13 13" fill="none" aria-hidden="true"><path d="M2.5 6.5h8M8 3.5l3 3-3 3" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg></button>
      </div>
    </div>
  )
}
